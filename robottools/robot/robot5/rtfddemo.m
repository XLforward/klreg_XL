...
% MATLAB function ode45() to integrate the joint acceleration.  It also allows for
% a user written function to compute the joint torque as a function of manipulator
% state.
%
%  To simulate the motion of the Puma 560 from rest in the zero angle pose with zero
% applied joint torques
	tic
	[t q qd] = fdyn(p560, 0, 10);
	toc
%
% and the resulting motion can be plotted versus time
	...
	ylabel('Joint 3 (rad)')
%
%  Clearly the robot is collapsing under gravity, but it is interesting to note that
% rotational velocity of the upper and lower arm are exerting centripetal and Coriolis
% torques on the waist joint, causing it to rotate.
