echo on
%
%  In the field of robotics there are many possible ways of representing positions
% and orientations, but the homogeneous transformation is well matched to MATLABs
% powerful tools for matrix manipulation.
%
%  Homogeneous transformations describe the relationships between Cartesian coordinate
% frames in terms of translation and orientation.  
...
pause	% any key to continue
%
% It is important to note that tranform multiplication is in general not commutative
